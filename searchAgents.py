...
def foodHeuristic(state, problem):
    ...
    #         dist = util.manhattanDistance(current_pos, foodlist[i])
    #         if min_dist == None or min_dist > dist:
    #             min_dist = dist
    #             idx = i
    #     distall += min_dist
    #     current_pos = foodlist[idx]
    #     foodlist.remove(foodlist[idx])
    # total = distall + foodGrid.count()
    # return total/2
    #
